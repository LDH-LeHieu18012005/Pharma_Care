...
module.exports = {
  ...
  async create(req, res, next) { try { await svc.create(req.body); res.redirect('/admin/staff'); } catch(e){next(e);} },
  ...
  async update(req, res, next) { try { await svc.update(req.params.id, req.body); res.redirect('/admin/staff'); } catch(e){next(e);} },
